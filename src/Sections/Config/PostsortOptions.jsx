...
const PostsortOptions = () => {
  ...
  return (
    <React.Fragment>
      ...
      <RadioButtons
        label="2-10. Include individual card comments screen (Step 3):"
      ...
      <RadioButtons
        label="2-11. Display cards from second most positive column:"
        buttonIdArray={["true", "false"]}
      ...
      <RadioButtons
        label="2-12. Display cards from second most negative column:"
        buttonIdArray={["true", "false"]}
